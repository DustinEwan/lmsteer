...
def save_steering_config(steering_config: dict, model_name: str, console: Console, base_path: str = "/workspace/lmsteer") -> None:
    ...
    try:
        ...
        console.print(f"[bold red]Error saving configuration file to {config_file_path}: {e}[/bold red]")
    except Exception as e:
        console.print(f"[bold red]An unexpected error occurred while saving configuration: {e}[/bold red]")
